...
public class CurrencyExchangeController {
	...
	public CurrencyExBean getExchange(@PathVariable String from,@PathVariable String to,@RequestHeader Map<String, String> headers)
	{
		printAllHeaders(headers);
		CurrencyExBean exchangeValue = repository.findByFromAndTo(from, to);
